...
## Email: hayleigharnold1@gmail.com
##
## PROBLEM : We are trying to simulate a slot machine in Pierson Hall. 
##
## ALGORITHM : 
...
def get_wager(bank : int) -> int:
    ...
    while (wager < 0) or (wager > bank):
        if(wager < 0):  
            ...
            wager = int(input("How many chips do you want to wager? ==> "))#Make sure to validate inputs.
        elif(wager > bank):
...
if __name__ == "__main__":
    ...
    while playing:
        ...
        while bank > 0:  #The game must stop if the user does not have money. 
